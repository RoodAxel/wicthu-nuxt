...
useSeoMeta({
  ...
  description: 'Matériel et équipement contemporain pour L\'Appel de Cthulhu : prix et catégories.'
})
</script>
...
<template>
  <ResourceListLayout
    title="Équipement Moderne"
    subtitle="Matériel et fournitures de l'ère moderne (années 1990)"
    quote="La technologie moderne offre plus de lumière dans les ténèbres — mais les ténèbres, elles, ne reculent pas."
    cite="— Manuel de terrain, Delta Green, 1994"
    accent="gold"
    max-width="1000px"
    :stats-cols="4"
    :stats-cols-mobile="2"
