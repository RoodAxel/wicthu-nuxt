...
.resource-card:not(.resource-soon):hover {
...
.resource-card:not(.resource-soon):hover .resource-arrow {
  color: var(--color-arcane);
...
.cta-card::before {
  ...
  position: absolute;
  inset: 0;
  background: radial-gradient(ellipse at 0% 50%, rgba(127, 179, 138, 0.05) 0%, transparent 60%);
  pointer-events: none;
}
